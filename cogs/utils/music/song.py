...
class Song:
    def __init__(self, song_url: str = None, uploader: str = None, title: str = None, duration: int = None, channel_url: str = None, thumbnail: str = None):
